...
try {
 bool = WebUI.verifyElementPresent(object, 0)
	...
	if(bool && username.length()<10) {
		...
		WebUI.click(findTestObject('Object Repository/IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/div_UsernameEdit'))
		WebUI.setText(findTestObject('Object Repository/IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/input_Username_username'),
			username+username)
		WebUI.click(findTestObject('IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/button_Save_EditUserName'))
		WebUI.click(findTestObject('IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/button_Close_Edit_UserName'))
		Thread.sleep(2000)
		WebUI.click(object)
		WebUI.click(findTestObject('Object Repository/IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/button_Account Settings'))
		WebUI.click(findTestObject('Object Repository/IFObject/Page_TEST CHANNEL - TEAM NAME Mattermost/div_UsernameEdit'))

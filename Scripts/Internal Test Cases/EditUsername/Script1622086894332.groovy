...
for (def rowNum = 1; rowNum <= findTestData('Internal/Internal Username').getRowNumbers(); rowNum++) {
...
WebUI.click(findTestObject('Object Repository/Account Setting/Page_TEST CHANNEL - TEAM NAME Mattermost/div_Username_col-sm-7'))

WebUI.setText(findTestObject('Object Repository/Account Setting/Page_TEST CHANNEL - TEAM NAME Mattermost/input_Username_username'), 
    findTestData('Internal/Internal Username').getValue(1, rowNum))

WebUI.click(findTestObject('Object Repository/Account Setting/Page_TEST CHANNEL - TEAM NAME Mattermost/button_Save'))

WebUI.click(findTestObject('Object Repository/Account Setting/Page_TEST CHANNEL - TEAM NAME Mattermost/button_Close'))
}

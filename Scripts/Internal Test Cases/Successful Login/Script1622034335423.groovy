...
WebUI.setText(findTestObject('Object Repository/Page_Mattermost/input_All team communication in one place, _dcc84b'), findTestData(
        'Internal/Internal Login Data').getValue(1, 1))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mattermost/input_All team communication in one place, _a3edc6'), 
    findTestData('Internal/Internal Login Data').getValue(2, 1))

WebUI.click(findTestObject('Object Repository/Page_Mattermost/button_Sign in'))

WebUI.verifyLinksAccessible(['https://chudenangcao2021.cf/cdnc-cnpm-2021/channels'])
